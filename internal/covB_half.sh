...
dothething ()
{
    ...
    then
        ...
        java -Xms512m -Xmx6G -jar $ITHE_GATKJAR -T UnifiedGenotyper -R $ITHE_HUMAN_GENOME -I $bam1 -o "$name_out.vcf" --intervals ${name_vcf2}_covB.bed --output_mode EMIT_ALL_SITES -glm BOTH > "$name_out.log" 2>&1
