...
my $vcf_filt_exe="$ITHE_INT/vcf_filtering.sh";

if (! -f "$vcf_filt_exe")
{
    die "The executable vcf_filtering.sh can't be located. Please, make sure that the environment variable ITHE_INT indicates the directory with this package of scripts\n";
}
...
{
    die "The gnomAD data can't be found. Make sure you hae configured the ITHE_GNOMAD configuration variale properly. Files: $GNOMAD, and $GNOMAD.tbi\n"
}
else
{
